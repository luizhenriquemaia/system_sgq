...
class formPoliPlanFix(forms.Form):
    ...
    combPintura = forms.ModelChoiceField(queryset=a11Insumos.objetos.filter(catins_id=52).order_by("descricao"),
                                         to_field_name="codigo")
    quantPintura = forms.DecimalField(max_digits=12, decimal_places=4, required=False)
    compPoli = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    largPoli = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    declPoli = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    repetPoli = forms.DecimalField(max_digits=12, decimal_places=2, min_value=0)
    distApoios = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    distMaosF = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0, required=False)
    ...
    latDir = forms.ChoiceField(choices=[(
        '0', 'livre'), ('1', 'rufo'), ('2', 'calha'), ('3', 'tampar')], required=False)
    diasSerralheiro = forms.DecimalField(max_digits=12, decimal_places=4, required=False)
    quantSerralheiros = forms.DecimalField(max_digits=12, decimal_places=4, required=False)
    diasAuxiliar = forms.DecimalField(max_digits=12, decimal_places=4, required=False)
    quantAuxiliares = forms.DecimalField(max_digits=12, decimal_places=4, required=False)
...
class formPoliPlanRet(forms.Form):
    ...
    combMotores = forms.ModelChoiceField(queryset=a11Insumos.objetos.filter(catins_id=53).order_by("descricao"),
                                              to_field_name="codigo")
    quantMotores = forms.DecimalField(max_digits=12, decimal_places=0, min_value=0)
    quantModulos = forms.DecimalField(max_digits=12, decimal_places=0, min_value=0)
    quantModMoveis = forms.DecimalField(max_digits=12, decimal_places=0, min_value=0)
    ...
    combPintura = forms.ModelChoiceField(queryset=a11Insumos.objetos.filter(catins_id=52).order_by("descricao"),
                                              to_field_name="codigo")
    quantPintura = forms.DecimalField(max_digits=12, decimal_places=2, min_value=0, required=False)
    compPoli = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    largPoli = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    declPoli = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    repetPoli = forms.DecimalField(max_digits=12, decimal_places=2, min_value=0)
    ...
    diasSerralheiro = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0, required=False)
    quantSerralheiros = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0, required=False)
    diasAuxiliar = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0, required=False)
    quantAuxiliares = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0, required=False)
    dificuldade = forms.ChoiceField(
        choices=[(1, 'fácil'), (2, 'médio'), (3, 'difícil')], required=False)
    apEstr = forms.BooleanField(required=False)
...
class formPoliCurvoFix(forms.Form):
    ...
    combPintura = forms.ModelChoiceField(queryset=a11Insumos.objetos.filter(catins_id=52).order_by("descricao"),
                                              to_field_name="codigo")
    quantPintura = forms.DecimalField(max_digits=12, decimal_places=2, min_value=0, required=False)
    cordaPoli = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    flechaPoli = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    largPoli = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    repetPoli = forms.DecimalField(max_digits=12, decimal_places=2, min_value=0)
    distApoios = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0)
    distMaosF = forms.DecimalField(max_digits=12, decimal_places=4, min_value=0, required=False)
