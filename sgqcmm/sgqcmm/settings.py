"""
Django settings for sgqcmm project.
...
secret_file = BASE_DIR.with_name('secret_key.txt')
text_secret = ''
with secret_file.open() as file:
    text_secret = file.readline()
SECRET_KEY = text_secret
...
WSGI_APPLICATION = 'sgqcmm.wsgi.application'
